...
//        int numberOfKitchen = 2;
        ...
        boolean hasBasemeent = true;
        boolean hasAttic = false;
        boolean isOnSale = false;
        double price = 9_999_999; // 9,999,99 --->you cant use koma ----> use underscore instead --->9_999_999
        String address = "123 Central Park";
        int zipcode = 12345;
        boolean hasPark = true;
        double rating = 4.9;

        String result = "The " + houseType +  "on" + address + "," + zipcode + "costs" + price + "The " + houseType +"has " + numberOfBathroom + "bathdooms, has " + numberOfBedroom + " bedrooms, has " + numberOfKitchen + "kitchen. \nIt also has a basement: " + hasBasemeent + " , has
